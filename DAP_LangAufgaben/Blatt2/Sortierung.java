...
public class Sortierung {
    ...
    public static void mergeSort(int[] array,int[] tempArray,int left,int right){
        ...
        int rightPointer=q+1,leftPointer=left;  //Pointer auf die jeweils aktuellen elemente im linken bzw. rechten teil array
        for(int currentI=left;currentI<=right;currentI++){
            if(leftPointer<=q&&rightPointer<=right)     // links und rechts sind valide möglichkeiten => wähle kleinste
